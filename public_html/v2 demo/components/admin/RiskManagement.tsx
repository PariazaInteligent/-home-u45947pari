    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
            ...
            <div className="flex items-center gap-2">
                <div className={`px-4 py-2 rounded-lg border flex items-center gap-2 font-mono text-xs font-bold transition-all ${
                    riskScore > 70 ? 'bg-red-900/20 border-red-500 text-red-500 animate-pulse' : 'bg-slate-900 border-white/10 text-slate-400'
                }`}>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <div 
                        ...
                        className={`cursor-pointer p-4 rounded-xl border transition-all relative overflow-hidden group ${
                            circuitBreaker ? 'bg-emerald-900/10 border-emerald-500/50' : 'bg-slate-900/50 border-white/5'
                        }`}
                    >
                    ...
                    <div 
                        ...
                        className={`cursor-pointer p-4 rounded-xl border transition-all relative overflow-hidden group ${
                            aiSupervision ? 'bg-cyan-900/10 border-cyan-500/50' : 'bg-slate-900/50 border-white/5'
                        }`}
                    >
                        <div className="flex justify-between items-start mb-2">
                    ...
                    <div 
                        ...
                        className={`cursor-pointer p-4 rounded-xl border transition-all relative overflow-hidden group ${
                            autoHedge ? 'bg-violet-900/10 border-violet-500/50' : 'bg-slate-900/50 border-white/5'
                        }`}
                    >
                        <div className="flex justify-between items-start mb-2">

    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="grid lg:grid-cols-3 gap-6 items-start">
            <div className="lg:col-span-2">
                <TiltCard glowColor="cyan" className="flex flex-col relative overflow-hidden">
                    ...
                    <div className="relative h-[300px] bg-slate-900/50 rounded-xl border border-white/5 p-4">
                        {/* Grid Lines */}
